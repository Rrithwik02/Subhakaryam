...
-- Insert default ceremony themes with proper JSONB casting
...
('Traditional Hindu', 'wedding', 
 '{"primary": "hsl(0, 70%, 50%)", "secondary": "hsl(45, 100%, 50%)", "accent": "hsl(30, 100%, 40%)", "background": "hsl(0, 0%, 98%)"}'::jsonb,
 '{"primary": "Playfair Display", "body": "Inter", "size": "medium"}'::jsonb,
 '{"patterns": ["mandala", "lotus"], "borders": "traditional", "icons": "vedic"}'::jsonb),

('Modern Elegant', 'wedding',
 '{"primary": "hsl(270, 50%, 40%)", "secondary": "hsl(320, 30%, 60%)", "accent": "hsl(50, 100%, 70%)", "background": "hsl(0, 0%, 99%)"}'::jsonb,
 '{"primary": "Inter", "body": "Inter", "size": "medium"}'::jsonb,
 '{"patterns": ["geometric"], "borders": "modern", "icons": "minimal"}'::jsonb),

('Festive Celebration', 'festival',
 '{"primary": "hsl(30, 90%, 50%)", "secondary": "hsl(0, 80%, 60%)", "accent": "hsl(60, 100%, 50%)", "background": "hsl(45, 100%, 98%)"}'::jsonb,
 '{"primary": "Playfair Display", "body": "Inter", "size": "large"}'::jsonb,
 '{"patterns": ["rangoli", "diyas"], "borders": "decorative", "icons": "festive"}'::jsonb),

('Spiritual Pooja', 'pooja',
 '{"primary": "hsl(30, 80%, 45%)", "secondary": "hsl(0, 0%, 20%)", "accent": "hsl(45, 100%, 60%)", "background": "hsl(0, 0%, 99%)"}'::jsonb,
 '{"primary": "Playfair Display", "body": "Inter", "size": "medium"}'::jsonb,
 '{"patterns": ["om", "trishul"], "borders": "spiritual", "icons": "religious"}'::jsonb)
