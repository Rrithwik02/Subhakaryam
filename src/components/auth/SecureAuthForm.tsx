    ...
    <Card className="w-full max-w-md p-8 space-y-6 bg-white shadow-lg">
      <div className="text-center">
        <h1 className="text-3xl font-display font-bold text-ceremonial-maroon mb-2">
          {showResetPassword ? "Reset Password" : (mode === "sign_up" ? "Create Account" : "Welcome Back")}
        </h1>
            ...
            <div className="flex items-center justify-between mb-1">
              ...
              {mode === "sign_in" && (
                <Button
                  type="button"
                  variant="link"
                  className="h-auto p-0 text-xs text-ceremonial-gold hover:text-ceremonial-gold/80"
