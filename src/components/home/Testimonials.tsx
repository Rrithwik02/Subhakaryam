    ...
    <section className="py-16 px-4 bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="p-6 bg-gradient-to-br from-ceremonial-cream to-white transform transition-all duration-300 hover:scale-105 hover:shadow-lg animate-slide-up-fade" style={{ animationDelay: '100ms' }}>
          ...
          <Card className="p-6 bg-gradient-to-br from-ceremonial-cream to-white transform transition-all duration-300 hover:scale-105 hover:shadow-lg animate-slide-up-fade" style={{ animationDelay: '200ms' }}>
            <p className="text-gray-600 mb-4">
          ...
          <Card className="p-6 bg-gradient-to-br from-ceremonial-cream to-white transform transition-all duration-300 hover:scale-105 hover:shadow-lg animate-slide-up-fade" style={{ animationDelay: '300ms' }}>
            <p className="text-gray-600 mb-4">
