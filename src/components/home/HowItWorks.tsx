      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center animate-slide-up-fade" style={{ animationDelay: '100ms' }}>
            <div className="w-16 h-16 bg-ceremonial-gold rounded-full flex items-center justify-center mx-auto mb-4 animate-float">
          ...
          <div className="text-center animate-slide-up-fade" style={{ animationDelay: '300ms' }}>
            <div className="w-16 h-16 bg-ceremonial-gold rounded-full flex items-center justify-center mx-auto mb-4 animate-float">
